...
def getSunSpec(basereg):
    ...
    print(manufacturer.decode('ascii'))
    if "OutBack_Power" in manufacturer.decode('ascii'):
        print(".. Outback Power device found")
    else:
        print(".. Not an Outback Power device. Detected " + manufacturer)
        return None
